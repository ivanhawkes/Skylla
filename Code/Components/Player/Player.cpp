...
#include "Components/Weapon/Bullet.h"
#include "Components/Player/SpawnPoint.h"
...
void CPlayerComponent::OnReadyForGameplayOnServer()
{
	...
	CSkyllaPlugin::GetInstance()->IterateOverPlayers([this, channelId](CPlayerComponent& player)
	{
